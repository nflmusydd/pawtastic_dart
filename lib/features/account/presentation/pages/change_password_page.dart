...
class _ChangePasswordPageState extends State<ChangePasswordPage> {
  ...
  Future<void> _executePasswordChange(String oldPassword, String newPassword) async {
    ...
    try {
      ...
      if (email == null)
        throw context.t.account.change_password.cannot_find_user_email.ucfirst();
      ...
      if (mounted) {
        SnackBarUtils.show(
            context,
            context.t.account.change_password.password_changed_successfully.ucfirst(),
              ...
              child: Column(
                children: [
                  ...
                  CustomTextField(
                    ...
                    obscureText: !_isPasswordVisible,
                    hintText: context.t.auth.reset_password.new_password
                        .toTitleCase(),
                  ...
                  CustomTextField(
                    ...
                    obscureText: !_isPasswordVisible,
                    hintText: context.t.auth.reset_password.confirm_new_password
                        .toTitleCase(),
