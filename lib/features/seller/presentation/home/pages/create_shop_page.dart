...
class _CreateShopPageState extends State<CreateShopPage> {
  ...
  void _nextStep() {
    if (_currentStep == 0) {
      if (_shopNameController.text.trim().isEmpty || 
        ...
        SnackBarUtils.show(context, context.t.account.create_shop.please_fill_in_all_fields.ucfirst(), type: SnackBarType.error);
        return;
      }
  ...
  void _showFinishConfirmation() {
    if (_recipientNameController.text.trim().isEmpty || 
      ...
      SnackBarUtils.show(context, context.t.account.create_shop.please_fill_pickup_address_date.ucfirst(), type: SnackBarType.error);
      return;
    }
    ...
    DialogUtils.showConfirmationDialog(
      ...
      message: context.t.account.create_shop.make_sure_the_store_data_and_pickup_address_are_correct.ucfirst(),
      ...
      child: Column(
        ...
        children: [
          ...
          CustomTextFieldRow(
            ...
            // label: context.t.account.create_shop.shop_name.toTitleCase(),
          ...
          CustomTextFieldRow(
            ...
            // label: context.t.account.create_shop.store_slug.toTitleCase(),
          ...
          CustomTextFieldRow(
            ...
            // label: context.t.account.create_shop.shop_description.toTitleCase(),
